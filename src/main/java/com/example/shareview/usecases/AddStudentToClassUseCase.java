...
public class AddStudentToClassUseCase {
    ...
    public AddStudentToClassUseCase(ClassGateway classGateway, UserGateway userGateway) {
    ...
    public void execute(Long classId, Long studentId) {
        ...
        clazz.addStudent(user);
        classGateway.addStudent(ClassMapper.toDto(clazz), UserMapper.toDto(user));
    }
}
